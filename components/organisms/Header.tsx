...
import ButtonHamburger from "$start/components/atoms/ButtonBurgues.tsx";
    ...
    <div class="px-4 z-10 relative border-b border-gray-200/50">
      <header class="top-0 z-40 bg-white/70 backdrop-blur-2xl pr-3 lg:pr-0 flex justify-between 2xl:justify-between 2xl:px-44 m-auto pt-4 mb-3">
        ...
        <div class="flex items-center">
          ...
          {/* Mobile Version */}
          <div class="md:hidden">
            {/* <button isMenuOpen={isMenuOpen} onClick={handleClick} class="focus:outline-none" type="button" aria-expanded="false" data-headlessui-state="">
          ...
          <div class={` ${
            ...
            <div class="absolute inset-x-0 top-0 z-10 p-4 origin-top-right transform md:hidden opacity-100 translate-y-0" tabindex="-1" data-headlessui-state="open" id="headlessui-popover-panel-:r5:">
              <div class="overflow-hidden bg-white rounded-lg shadow-md p-2.5">
                  <div class="flex justify-end">
                    <button isMenuOpen={isMenuOpen} onClick={handleClick} type="button" data-headlessui-state="open">
